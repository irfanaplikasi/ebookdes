...
import { createClient } from "../../lib/supabase/server"; // Impor diperbaiki
...
export default function Dashboard() {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        console.error("Unexpected error in loadData:", error.message);
  ...
  const handleDeleteEbook = async (ebookId: string) => {
    ...
    try {
      ...
      // Refresh jika tidak redirect otomatis
              ...
              <span>
                ...
                {process.env.NODE_ENV === "development" && (
                  <span className="ml-2 text-xs opacity-75">
                    (Debug: {ebooks.length} ebooks loaded, Admin: {isAdmin ? "Yes" : "No"})
                  </span>
                )}
              </span>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-6">
                <Dialog>
                  ...
                  <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
                    ...
                    <form action={updatePageContentAction} className="space-y-4">
                ...
                <Dialog>
                  ...
                  <DialogContent className="max-w-md">
                    ...
                    <form action={createEbookAction} className="space-y-4">
                      ...
                      />
                      <Input name="pdf_url" placeholder="URL file PDF" required />
                      <Button type="submit" className="w-full">
                        Tambah E-book
                      </Button>
                    </form>
